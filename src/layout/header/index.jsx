...
const Header = (props) => {
    ...
    return (
        <Fragment>
            <div className="page-header" onClick={() =>
                document.querySelector(".language_nav_translate").classList.remove("active")
            }>
                <Row className="header-wrapper m-0">
                    ...
                    <LeftHeader />
                    <RightHeader sidebarClose={sidebarClose} setSidebarClose={setSidebarClose} filteredMenu={filteredMenu} setFilteredMenu={setFilteredMenu} />
                </Row>
            </div>
        </Fragment>
    );
