                        ...
                        style = {{borderRadius: '3px'}}
                          ...
                          className={`sidebar-link sidebar-title ${menuItem.active
                            ...
                            : ""
                              ...
                              (item) =>
                                window.location.pathname.slice(0, -3).includes(item.path?.slice(0, item.path.lastIndexOf('/')))
                            ) && "included"
                            } ${menuItem.children.find(
                              (item) =>
                                window.location.pathname.slice(0, -3).includes(item.path?.slice(0, item.path.lastIndexOf('/')))
                                ...
                                {childrenItem.type === "link" ? (
                                  <Link
                                    ...
                                    className={`mb-1 ${childrenItem.active &&
                                      window.location.pathname.slice(0, -3).includes(childrenItem.path.slice(0, childrenItem.path.lastIndexOf('/')))
                                      ? "active"
                                      : ""
                                      } 
                                    ${window.location.pathname.slice(0, -3).includes(childrenItem.path.slice(0, childrenItem.path.lastIndexOf('/')))
