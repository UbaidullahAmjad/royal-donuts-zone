...
export const AllergeneName = 'Allergen Name'
...
// form creation
export const LatitudeDuMagasin = "Store Latitude"
export const  LongitudeDuMagasin = "Store Longitude"
export const  NomDuMagasin = "Name of the Shop"
export const  MagasinFrench = "Store (French)"
export const  Téléphoner = "Call"
export const  Url = "Url"
export const  NomInstagram = "Instagram username"
export const  CodePostal = "Code Postal"
export const  MotInstagram = "Instagram password"
export const magasin = "Store"
export const  jours = "Days"
export const Name = "Name"
export const Price = "Price"
export const PackageItem = "Package Item"
export const Supplier = "Supplier"
export const Phone = "Phone"
export const EmailAddress = "Email Address"
export const Country = "Country"
export const HeureDouverture = "Opening time"
export const HeureDeFermeture = "Closing hour"
export const frenchCode = 'french code'
export const frenchAmount = 'french amount'
export const frenchSymbol = 'french symbol'
export const availUsers = 'available users'
export const frenchCoupen = 'French Coupen'
export const CouchesDonut =  "Couches Donut"
export const Couche =  "Layer"
export const ContenuEnFrancais = "Content in French"
export const ContenuEnAnglais = "Content in English"
export const TitreEnAnglais = "English title"
export const TitreEnFrançais = "French title"
export const UrlDeLaPage = "Page Url"
export const Produit = "Product"
export const Catégorie= "Category"
export const Prix= "Price (€)"
export const Remplissage= "Filling"
export const glaçage= "Glaze"
export const Garniture= "Topping"
export const sauce= "sauce"
export const LaDescription= "Description"
export const minQuantity = 'Minimum Quantity'
export const unit = 'Unit'
export const unitAbrreviation = 'french Abbreviation'
export const Role = 'Role'
export const franchiseName = 'Franchise Name'
export const customer = 'Customer'
export const nameAbrreviation = 'Name Abrreviation'
export const deliveryCompany = 'Delivery Companies'
export const faxNumber = 'Fax Number'
export const minOrderAmount = 'Minimum Order Amount'
export const deliveryFee = 'Delivery Fee'
export const Rule = 'Rule'
export const deliveryDays = 'Delivery Days'
export const AcceptanceTime = 'Acceptance Time'
export const treatmentDay = 'Treatment Days'
export const customerName = "Customer Name"
export const  supplierName = "Supplier Name"
export const RuleName = "Rule Name"
export const associateRule = "Associate Rule"
export const createNewRole = 'Create New Role'
export const footerSignature = 'Footer Signature'
export const instaUser = 'french. Instagram username'
export const frenchInstaUser = 'french. UserName'
export const curserSec = 'Cursor Section'
export const underTitle = 'Text under Title'
export const badge = 'Badge'
export const label = 'Label'
export const packageSec = 'Package Section'
export const pricingSection = 'Pricing Section'
export const headerLogo = 'Header Logo'
export const  headerFooterLogo = "Header/Footer Logo"
export const footerLogo = 'Footer Logo'
export const  instaLink = 'Instagram Link'
export const  fbLink = 'Facebook Link'
...
export const LayoutOption = "Layout option"
