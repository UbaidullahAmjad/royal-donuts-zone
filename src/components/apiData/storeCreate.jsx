...
const Products = (props) => {
  ...
  // const handleControlledDropzonChangeStatus = ({ file }, status, allFiles) => {
  ...
  const onSubmit = (data) => {
    ...
    // }
    let newArr = arr.filter(item => item.name !== "" && item.day_start_time !== "" && item.MonEndTime !== ""
      && item.day_start_time !== "" && item.TueEndTime !== ""
      && item.day_start_time !== "" && item.WedEndTime !== ""
      && item.day_start_time !== "" && item.ThuEndTime !== ""
      && item.day_start_time !== "" && item.FriEndTime !== ""
      && item.day_start_time !== "" && item.SatEndTime !== ""
      && item.day_start_time !== "" && item.SunEndTime !== "")
  ...
  const setDays = () => {
    if (singleDay != null) {
      if (singleDay.name !== '' && singleDay.day_start_time !== '' && singleDay.day_end_time !== '') {
        console.log('single day', singleDay)
                ...
                >
                  <div className="form-row">
                    ...
                    {/* <Col md="6 mb-3">
                      ...
                      <span>
                        {errors.open_time && trans("field is required")}
                      </span>
                      <div className="valid-feedback">
                        {trans("Looks good!")}
                      </div>
                    ...
                    <Col md="6 mb-3">
                      ...
                      <span>
                        {errors.close_time && trans("field is required")}
                      </span>
                      <div className="valid-feedback">
                        {trans("Looks good!")}
                      </div>
                    ...
                    <Col md="12 mb-3">
                      <Label htmlFor="validationCustom02">{trans(jours)}</Label>
                      <Controller
                        control={control}
                        name="days"
                        rules={{ required: true }}
                        render={() => (
                          <Typeahead
                            ...
                            className="mt-2 typehead_form_control"
                            clearButton
                            //   defaultSelected={days.slice(0, 2)}
                            onChange={(selected) => TypeAheadChanged(selected)}
                            labelKey="name"
                            multiple
                            options={days}
                          />
                    ...
                    <Col md="12 mb-3">
                      ...
                      {/* <Controller
                        ...
                        name="days"
                        rules={{ required: true }}
                        key={StoreDays != null ? StoreDays : []}
                        defaultValue={StoreDays != null ? StoreDays : []}
                        render={() => (
                          <Typeahead
                            id="multiple-typeahead"
                            labelKey="name"
                            ...
                            clearButton
                            options={days}
                            placeholder={trans("Choose Days")}
                            onChange={(selected) => ChangeStoreDays(selected)}
                            key={StoreDays != null ? StoreDays : []}
                            defaultSelected={StoreDays != null ? StoreDays : []}
                          />
                        )}
                      /> */}
                      <span>{errors.days && trans("field is required")}</span>
                    ...
                    <Col md="12 mb-3">
                      ...
                      />
                      <span className="text-danger">{errors.image && trans("field is required")}</span>
                      <div className="valid-feedback">
                        {trans("Looks good!")}
                      </div>
                    </Col>
